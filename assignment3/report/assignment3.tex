...
\begin{figure}[H]
    \includegraphics[scale=0.25]{images/1a_confmatrix_train.png}
    \includegraphics[scale=0.25]{images/1a_confmatrix_test.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1A_ovo_01.png}
    \caption{Decision region for class y=0 and y=1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1A_ovo_02.png}
    \caption{Decision region for class y=0 and y=2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1A_ovo_03.png}
    \caption{Decision region for class y=0 and y=3}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1A_ovo_12.png}
    \caption{Decision region for class y=1 and y=2}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1A_ovo_13.png}
    \caption{Decision region for class y=1 and y=3}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1A_ovo_23.png}
    \caption{Decision region for class y=2 and y=3}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1A_SVM_full_decision_plot.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1B_SVM_poly_train_confmat.png}
    \includegraphics[scale=0.25]{images/1B_SVM_poly_Test_confmat.png}
    \caption{Confusion matrix for Train and Test data respectively}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1B_SVM_poly_decision_plot.png}
...
The validation accuracy is highest for [C:1.0, gamma:1.0]. Hence those hyper-parameters are used for further calculations. Accuracy on test data with those hyper-parameters is obtained to be \textbf{1.00}. 

\subsubsection{Confusion matrices for Train and Test data: Gaussian Kernel}

\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1B_SVM_gauss_train_confmat.png}
    \includegraphics[scale=0.25]{images/1B_SVM_gauss_Test_confmat.png}
    \caption{Confusion Matrix for Train and Test data respectively}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/1B_SVM_gauss_decision_plot.png}
    \caption{Decision region plot for dataset 1b: SVM with Gaussian Kernel}
    \label{myfig:gauss_db}
\end{figure}

The distinguishing feature between figure \ref{myfig:gauss_db} and figure \ref{myfig:poly_db} is the behaviour at the edges. Also, the decision boundary obtained using polynomial kernel has a discontinuity in the region $x1 \epsilon (-0.5,0.5)$ and $x2 \epsilon (3,4)$
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.25]{images/2A_SVM_gauss_train_confmat.png}
    \includegraphics[scale=0.25]{images/2A_SVM_gauss_Test_confmat.png}
